...
async function makeImage({ one, two }) {
  const bgUrl = "https://drive.google.com/uc?id=1p22PARgA-hFqmK_kNMMl-dCRuNR_xhqd";
  ...
  bg.composite(circOne.resize({ w: 180, h: 180 }), 300, 150);
  bg.composite(circTwo.resize({ w: 180, h: 180 }), 550, 290);
