...
async function makeImage({ one, two }) {
  ...
  bg.composite(circOne.resize({ w: 180, h: 180 }), 100, 100);
  bg.composite(circTwo.resize({ w: 180, h: 180 }), 400, 420);
...
module.exports.onStartBadol = async function (api, event, args) {
  ...
  if (!targetID) {
    ...
    return api.sendMessage("『 ⚠️ 』অনুগ্রহ করে একজনকে মেনশন দিন অথবা কারো মেসেজে রিপ্লাই দিন!", threadID, messageID);
  }
  ...
  const messages = [
    ...
    "🥵 মোড অ্যাক্টিভেটেড! মজা দেখুন!",
    "⚡ সাবধান! এটা স্রেফ শুরু মাত্র!",
    "💦 ফাক মোড অন! সামলে থাকুন!"
  ];
